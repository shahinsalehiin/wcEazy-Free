<div class="tab_body_title">
    <h1><?php _e ('Invoice Settings', 'wceazy'); ?></h1>
</div>

<div class="wceazy_form_group pdf_invoice_settings_bar">
    <div class="label_title">
        <h4><?php _e ('Disable for', 'wceazy'); ?></h4>
    </div>
...
<div class="wceazy_form_group pdf_invoice_settings_bar">
    ...
    <div class="label_content">
        <div class="wceazy_module_list_items">
            <div class="wceazy_module_item wceazy_invoice_input_label">
...
<div class="wceazy_form_group pdf_invoice_settings_bar">
    <div class="label_title">
        <h4><?php _e ('Invoice Number Format', 'wceazy'); ?> <span class="wceazy_get_pro">(Pro)</span></h4>
    </div>
...
<div class="wceazy_form_group pdf_invoice_settings_bar">
    <div class="label_title">
        <h4><?php _e ('Order Number as Invoice Number', 'wceazy'); ?></h4>
    </div>
...
<div class="wceazy_form_group pdf_invoice_settings_bar wfpi_start_invoice_number">
    <div class="label_title">
        <h4><?php _e ('Invoice Start Number', 'wceazy'); ?></h4>
    </div>
...
<div class="wceazy_form_group pdf_invoice_settings_bar">
    <div class="label_title">
        <h4><?php _e ('Prefix', 'wceazy'); ?> <span class="wceazy_get_pro">(Pro)</span></h4>
    </div>
...
<div class="wceazy_form_group pdf_invoice_settings_bar">
    <div class="label_title">
        <h4><?php _e ('Suffix', 'wceazy'); ?> <span class="wceazy_get_pro">(Pro)</span></h4>
    </div>
