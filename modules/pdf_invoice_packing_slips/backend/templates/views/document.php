<div class="tab_body_title">
    <h1><?php _e ('PDF Document', 'wceazy'); ?></h1>
</div>

<div class="wceazy_form_group pdf_invoice_settings_bar">
    <div class="label_title">
        <h4><?php _e ('Deactivate Invoice?', 'wceazy'); ?></h4>
    </div>
 ...
 <!--<div class="wceazy_form_group pdf_invoice_settings_bar">
    <div class="label_title">
        <h4><?php //_e ('Deactivate Packing Slip?', 'wceazy'); ?></h4>
    </div>
...
<div class="wceazy_form_group pdf_invoice_settings_bar">
    <div class="label_title">
        <h4><?php _e ('Deactivate Shipping Label?', 'wceazy'); ?></h4>
    </div>
