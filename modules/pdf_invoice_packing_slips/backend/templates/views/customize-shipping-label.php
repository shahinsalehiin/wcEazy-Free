...
<div class="tab_body_title">
    <h1><?php _e ('Customize Shipping Label', 'wceazy'); ?></h1>
</div>
            ...
            <div class="wfpdf_invoice_container wfpdf_shipping_label_container">
                <div class="wfpdf_invoice_main">
                            ...
                            <div class="wfpdf_shipping_label wfcpss_logo">
                                <div class="wfpdf_company_logo">
                                    <div class="wfpdf_company_logo_img_box">
                                        <img class="wfpdf_company_logo_img" src="<?php echo !empty($this->wfpi_settings) && !empty($this->wfpi_settings['wfpi_shop_logo']) ? $this->wfpi_settings['wfpi_shop_logo'] : WCEAZY_MODULES_DIR . "/" . $this->module_slug . '/assets/img/no-image.jpg'; ?>" alt="Shop Logo">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="wfcpi_loader" style="display:none;">
                        <img src="<?php echo WCEAZY_IMG_DIR . 'popup_spinner.svg' ?>" alt="wceazy customize loader">
                    </div>
