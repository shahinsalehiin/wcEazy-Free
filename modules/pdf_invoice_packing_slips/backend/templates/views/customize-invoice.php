...
<div class="tab_body_title">
    <h1><?php _e ('Customize Invoice', 'wceazy'); ?></h1>
</div>

<div class="wceazy_customize_pdf_invoice_container wfpdf_invc_row wfpdf_invc_clearfix">
    <div class="wceazy_customize_pdf_invoice_topbar wfpdf_invc_clearfix">
        <div class="wceazy_customize_pdf_invoice_topbar_left wfpdf_invc_float_left">
            <h4>Invoice Layout</h4>
        </div>
        <div class="wceazy_customize_pdf_invoice_topbar_right wfpdf_invc_float_right">
    ...
    <?php
        if(!empty($order)){ ?>
            ...
            <div class="wceazy_pdf_invoice_customize_left wfpdf_invc_col_9 wfpdf_invc_float_left">
                    ...
                    <div class="wfpdf_invoice_container">
                        <div class="wfpdf_invoice_main">
                                    ...
                                    <div class="wfpdf_company_logo">
                                        <div class="wfpdf_company_logo_img_box">
                                            <img class="wfpdf_company_logo_img"
                                                 src="<?php echo !empty($this->wfpi_settings) && !empty($this->wfpi_settings['wfpi_shop_logo']) ? $this->wfpi_settings['wfpi_shop_logo'] : WCEAZY_MODULES_DIR . "/" . $this->module_slug . '/assets/img/no-image.jpg'; ?>"
                                                 alt="Shop Logo">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wfpdf_invc_col_4 wfpdf_invc_float_left wfcpi_from_address">
                                    <div class="wfpdf_company_address">
                                        ...
                                        <div class="wfpdf_billing_address_val">
                                            <ul>
                                                <li class="wfpci_fa_shop_name"><?php echo !empty($this->shop_info) ?$this->shop_info['shop_name'] : ''; ?></li>
                                                <li class="wfpci_fa_address1"><?php echo !empty($this->shop_info) ? $this->shop_info['address1'] : ''; ?></li>
                                                <li class="wfpci_fa_city"><?php echo !empty($this->shop_info) ? $this->shop_info['city'] : ''; ?></li>
                                                ...
                                                <li class="wfpci_fa_country"><?php echo !empty($this->shop_info) ? WC()->countries->countries[ $this->shop_info['country'] ] : ''; ?></li>
                                                <li class="wfpci_fa_postcode"><?php echo !empty($this->shop_info) ? $this->shop_info['postcode'] : ''; ?></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                foreach ( $order_items as $key => $item ) {
                                                    ...
                                                    <tr>
                                                        <td class="image_td"><img
                                                                    src="<?php echo WCEAZY_MODULES_DIR . "/" . $this->module_slug . '/assets/img/no-image.jpg'; ?>"
                            ...
                            <div class="wfcpi_loader" style="display:none;">
                                <img src="<?php echo WCEAZY_IMG_DIR . 'popup_spinner.svg' ?>" alt="wceazy invoice customize loader">
                            </div>
    ...
    <div class="wceazy_pdf_invoice_customize_right wfpdf_invc_sidebar_right_4 wfpdf_invc_float_right">
        <div class="wceazy_pdf_invoice_customize_sidebar">
            ...
            <div class="invoice_document_title" style="cursor: pointer">
                Paid Stamp <span class="wceazy_get_pro" style="margin-left: -45%;">(Pro)</span>
                <div class="wfpi_sidebar_toggle">
                    <label class="invoice_sidebar_switch">
                        <label class="wfpi_customize_sidebar_toggle">
                            <input id="wfpi_enable_paid_stamp" class="wfcpi_controls" type="checkbox" disabled>
                            <span class="slider round"></span>
                        </label>
                    </label>
                </div>
