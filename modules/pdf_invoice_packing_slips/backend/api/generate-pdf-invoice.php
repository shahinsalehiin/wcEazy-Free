...
if ($this->base_admin->base_admin->db->getModuleStatus ($this->base_admin->module_slug)) {
    ...
    <head>
        ...
        <style>
            ...
            /* wceazy pdf invoice customize left */
            .wceazy_pdf_invoice_customize_left {
                width: 100%;
                display: block;
            }

            .wceazy_pdf_invoice_customize_left h4 {
                color: #050505;
                font-weight: 600;
                font-size: 18px;
            }
    ...
    <body>
    <div class="wceazy_pdf_invoice_customize_left">
                            ...
                            <div class="wfpdf_company_logo">
                                <div class="wfpdf_company_logo_img_box">
                                    <img class="wfpdf_company_logo_img"
                                         src="<?php echo !empty($this->base_admin->wfpi_settings) && !empty($this->base_admin->wfpi_settings['wfpi_shop_logo']) ? $this->base_admin->wfpi_settings['wfpi_shop_logo'] : WCEAZY_MODULES_DIR . "/" . $this->base_admin->module_slug . '/assets/img/no-image.jpg'; ?>"
                                         alt="Shop Logo">
                                </div>
                            </div>
                        </div>
                                ...
                                foreach ($order_items as $key => $item) {
                                    ...
                                    <tr>
                                        <td class="image_td"><img
                                                    src="<?php echo WCEAZY_MODULES_DIR . "/" . $this->base_admin->module_slug . '/assets/img/no-image.jpg'; ?>"
    ...
    $this->base_admin->utils->wceazy_generate_pdf_invoice ($content, $order_id);
