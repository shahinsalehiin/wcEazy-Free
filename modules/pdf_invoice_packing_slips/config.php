...
// load dompdf vendor
include_once WCEAZY_MODULES_PATH . "/" . $module_slug . "/vendor/autoload.php";

include_once WCEAZY_MODULES_PATH . "/" . $module_slug . "/includes/pdf-invoice-utils.php";
...
$this->modules_obj[$module_slug] = new wcEazyPdfInvoiceAdmin($base_admin, $module_slug, $module_title);

new wcEazyPdfInvoiceFrontend($base_admin, $module_slug, $module_title);
