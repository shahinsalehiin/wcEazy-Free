<div id="wceazy_coupon_generate_dashboard">
    <form action="" method="post" id="form_wceazy_coupon_generator">
        <div class="coupon_generate_content_wrapper">
            <div class="coupon_generate_top_form">
                <div class="wceazy_row">
                    <div class="wceazy_col_lg_4">
                        <div class="wceazy_form_group">
                            <label for="coupon_generator_prefix">Prefix <span class="wceazy_get_pro">(Pro)</span></label>
                            <input class="wceazy_text_control" type="text"
                    ...
                    <div class="wceazy_col_lg_4">
                        <div class="wceazy_form_group">
                            ...
                            <input onkeyup="removeChar(this);" class="wceazy_text_control" type="text" value=""
                    ...
                    <div class="wceazy_col_lg_4">
                        <div class="wceazy_form_group">
                            <label for="coupon_generator_coupon_type" class="mb20">Coupon Type <span class="wceazy_get_pro">(Pro)</span></label>
                            <select class="wceazy_select_control wceazy_select2">
            ...
            <div class="single_modules_bottom_form">
                            ...
                            <div class="coupon_tab_body" data-id="coupon_tab_general">
                                ...
                                <div class="tab_body_form" id="tab_body_form">
                                    ...
                                    <div class="wceazy_form_group">
                                        ...
                                        <input class="wceazy_text_control" type="text" name="coupon_generator_coupon_amount"
                                    ...
                                    <div class="wceazy_form_group">
                                        ...
                                        <input type="date" class="wceazy_text_control"
                                ...
                                <div class="tab_body_form" id="tab_body_form">
                                    ...
                                    <div class="wceazy_form_group">
                                        ...
                                        <select name="coupon_generator_product_ids[]" id="coupon_generator_product_ids"
                                                class="wceazy_select_control wceazy_select2" multiple="multiple">
                                            <option value=""> Please select</option>
                                            <?php
                                    ...
                                    <div class="wceazy_form_group">
                                        ...
                                        <input class="wceazy_text_control" type="text" name="coupon_generator_customer_email"
                            ...
                            <div class="coupon_tab_body" data-id="coupon_tab_usage_limits">
                                ...
                                <div class="tab_body_form" id="tab_body_form">
                                    <div class="wceazy_form_group">
                                        ...
                                        <input class="wceazy_text_control" type="number"
                                    ...
                                    <div class="wceazy_form_group">
                                        ...
                                        <input class="wceazy_text_control" type="number" value=""
                ...
                <div class="wceazy_bottom_btn">
                    <button type="button" onclick="wceazy_submit_coupon_generator();" class="wceazy_save_btn coupon_generator_btn"
                            href="javascript:void(0);"> Generate Coupons </button>
                </div>
            </div>
        </div>
    </form>
    <div class="wceazy_popup d_flex">
        <div class="wceazy_popup_inar">
            <div class="generating_coupon">
                <p>Generating Coupons</p>
                <img src="<?php echo WCEAZY_MODULES_DIR . 'coupon_generator/assets/img/popup_spinner.svg' ?>" alt="">
            </div>
            <div class="successes_message">
                <p><span class="coupon_count"></span> Coupons Generated <br/>Successfully!</p>
                <button class="wceazy_save_btn generate_coupon_export_csv">Export as CSV</button>
                <span class="dashicons dashicons-dismiss wceazy_close_popup"></span>
            </div>
