...
if (!class_exists ('wcEazyOneClickCheckoutFrontend')) {
    class wcEazyOneClickCheckoutFrontend
    {
        ...
        public function __construct ($base_admin, $module_slug, $module_title){
            ...
            new wcEazyOneClickCheckoutFrontendAjax($this);
        ...
        public function wceazy_module_frontend_enqueue ($page) {
            ...
            $this->base_admin->utils->module_enqueue_script ($this->module_slug, "frontend", "frontend.js", array('jquery'));
             ...
             // create localize
             wp_localize_script( "wceazy-".$this->module_slug."-frontend", 'wceazy_occ_frontend_object', array(
                'ajaxurl' => admin_url( 'admin-ajax.php' ),
                'security' => wp_create_nonce( 'wceazy_occ_hashkey' ),
