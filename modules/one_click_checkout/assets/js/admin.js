...
function wceazy_one_click_checkout_init() {
    // init module
    $('#wceazy_one_click_checkout_header').show();
    $('#wceazy_one_click_checkout_container').show();
};

var $wfOneClickCheckoutAdmin = {
    wfocc_settings       : JSON.parse(wceazy_occ_admin_object.wceazy_occ_settings),
    wfocc_settings_form  : "#wceazy_form_one_click_checkout",
    ...
    init_wf_one_click_checkout_admin: function(){
        ...
        jQuery(document).ready(function($) {
            ...
            $(".wceazy_one_click_checkout_right_content .wceazy_one_click_checkout_tab_body").hide();
            $(".wceazy_one_click_checkout_right_content .wceazy_one_click_checkout_tab_body[data-id='wceazy_one_click_checkout_general']").show();

            $(".wceazy_one_click_checkout_data_tabs .tab_item").unbind("click");
            $(".wceazy_one_click_checkout_data_tabs .tab_item").bind("click", function () {

                $(".wceazy_one_click_checkout_data_tabs .tab_item").removeClass('tab_item_active');
                $(this).addClass('tab_item_active');

                $(".wceazy_one_click_checkout_right_content .wceazy_one_click_checkout_tab_body").hide();
                $(".wceazy_one_click_checkout_right_content .wceazy_one_click_checkout_tab_body[data-id='" + $(this).data('target') + "']").show();
            });
    ...
    submit_wfocc_settings : function (e) {
        e.preventDefault();
        let $submit_button = $('.wceazy_one_click_checkout_btn');
        $submit_button.text( 'Please Wait....' );
        $submit_button.addClass( 'wceazy-occ-btn-disabled' );
        $submit_button.prop( 'disabled', true );

        let $post_data = {'action': 'wceazy_save_one_click_checkout_settings', 'data': $($wfOneClickCheckoutAdmin.wfocc_settings_form).serializeArray()};
        ...
        $.ajax({
            ...
            success: function(res){
                ...
                if ($obj.status == 'true') {
                    ...
                    $submit_button.removeClass('wceazy-occ-btn-disabled');
