...
<form action="#" id="posts-filter" method="get">
    <div class="tablenav top">
        ...
        <div class="alignleft actions">
            ...
            <span class="wceazy_get_pro">(Pro)</span>
        </div>
    ...
    <table id="wceazy_auto_apply_coupon_table" class="widefat fixed striped table-view-list">
        <thead>
...
<div class="auto_apply_coupon_popup wceazy_popup d_flex">
    <div class="wceazy_popup_inar">
        <div class="successes_message">
            ...
            <div class="wceazy-btn-wrapper">
                <button type="button" class="wceazy-btn-danger wceazy-btn-trigger-danger" onclick="wfaca_close_popup();">No</button>
                <button type="button" class="wceazy-btn-success wceazy-btn-trigger-success">Yes</button>
            </div>
<!--            <span class="dashicons dashicons-dismiss wceazy_close_popup" onclick="wfaca_close_popup();"></span>-->
<!--	        <i class="demo-icon icon-cancel wceazy_close_popup" onclick="wfaca_close_popup();">&#xe904;</i>-->
	        <i class="demo-icon icon-cross wceazy_close_popup" onclick="wfaca_close_popup();">&#xe901;</i>
        </div>
    </div>
</div>
