...
include_once WCEAZY_MODULES_PATH . "/" . $module_slug . "/includes/AutoApplyCouponUtils.php";
...
$this->modules_obj[$module_slug] = new wcEazyAutoApplyCouponAdmin($base_admin, $module_slug, $module_title);