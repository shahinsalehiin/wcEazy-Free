...
var $wfPsbFrontend = {
    ...
    wfpsb_fronted_settings  : JSON.parse(wceazy_psb_jsfrontend.wfpsb_fronted_settings),
    wfpsb_security          : wceazy_psb_jsfrontend.security,
    psb_ajaxurl             : wceazy_psb_jsfrontend.ajaxurl,
    wfpsb_add_to_cart_btn   : '.wceazy_psb_add_to_cart_btn',
    ...
    init_wfpsb_frontend: function(){
        ...
        jQuery(document).ready(function($) {
            ...
            if ($wfpsb_show_only_scroll == 'yes') {
                ...
                $(window).scroll(function () {
                    ...
                    if (scroll >= $wfpbs_scroll_pixels) {
                        $(".wceazy_psb_menu_before").addClass("active");
                    }
                    if (scroll <= $wfpbs_scroll_pixels) {
                        $(".wceazy_psb_menu_before").removeClass("active");
                    }

                    // for footer scroll
                    if (scroll >= $wfpbs_scroll_pixels) {
                        $(".wceazy_psb_menu_after").addClass("active");
                    }
                    if (scroll <= $wfpbs_scroll_pixels) {
                        $(".wceazy_psb_menu_after").removeClass("active");
                    }
            ...
            $('body').addClass('wceazy-sticky-bar');
            ...
            // set variation
            $('.wceazy_psb_variation').on('change', function () {
                var $variationID = $(".wceazy_psb_variation option:selected").attr('data-variation_id');
            ...
            $('.wfpsb_qty_input').on('change', function () {
                ...
                $('.wceazy_psb_add_to_cart_btn').attr("data-quantity", $wfpsb_qty);
                $('.wceazy_psb_variation').attr("data-quantity", $wfpsb_qty);
            });
    ...
    trigger_set_wfpsb_attr: function () {
        ...
        var $variationID = $(".wceazy_psb_variation option:selected").attr('data-variation_id');
        var $variation = $('.wceazy_psb_variation').val();
        $('.wfpsb_addtocart_variation').attr( "data-variation_id", $variationID );
        $('.wfpsb_addtocart_variation').attr( "data-variation", "pa_option=" + $variation );
