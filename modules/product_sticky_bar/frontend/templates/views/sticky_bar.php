<?php
    ...
    // generate settings
    $psb_settings = array();
    $wceazy_psb_settings = get_option ('wceazy_psb_settings', true);
    $psb_settings = json_decode ($wceazy_psb_settings);
...
<style>
    ...
    #wceazy_psb_menu .woocommerce .star-rating {
        color: var(--product_rating_color);
    }

    #wceazy_psb_menu .woocommerce .product_rating_count {
        color: var(--product_rating_count_color);
    }

    #wceazy_psb_menu .wceazy_psb_menu_right .price .product_price_code {
        color: var(--product_price_color);
        font-size: var(--product_price_font_size);
    }

    #wceazy_psb_menu .wceazy_psb_menu_right .wceazy_psb_add_to_cart_btn {
    ...
    #wceazy_psb_menu .wceazy_psb_menu_right .wceazy_psb_add_to_cart_btn:hover {
        background: var(--btn_bg_hover_color);
        border-color: var(--btn_border_hover_color);
        color: var(--btn_font_hover_color);
    }

    .wceazy_psb_menu_left_inner .product_media img {
        border-radius: <?php echo ($image_shape == 'round') ? 50 . '%' : 0; ?>;
    }

</style>

<div style="height: <?php echo $wrapper_height . 'px'; ?>" id="wceazy_psb_menu"
     class="<?php echo ($wfpsb_show_on_desktop == 'yes') ? 'wfpsb_desktop' : ''; ?> <?php echo ($wfpsb_show_on_mobile == 'yes') ? 'wfpsb_mobile' : ''; ?> wceazy_psb_menu_<?php echo $this->wfpsb_show_in; ?>">
    <div class="wceazy_psb_menu_container">
        <div class="wceazy_psb_menu_row">
            <div class="wceazy_psb_menu_left">
                <div class="wceazy_psb_menu_left_inner">
                    <?php
            ...
            <div class="wceazy_psb_menu_right">
                <div class="price">
                ...
                if (!empty($variations) && $wfpsb_enable_variable_product == 'yes') {
                    ...
                    <div class="wceazy_psb_variations">
                        <select id="wfpsb_pa_size" class="wceazy_psb_variation" name="wfpsb_attribute_pa_size">
                ...
                <div class="wfpsb_add_cart_btn">
                    ...
                    if (!empty($variations) && $wfpsb_enable_variable_product == 'yes') { ?>
                        ...
                        <a
                                ...
                                class="ajax_add_to_cart wfpsb_addtocart_variation product_type_variation add_to_cart_button wceazy_psb_add_to_cart_btn variation">Add
                            To Cart</a>
                    ...
                    <?php } else { ?>
                        <a
                                ...
                                data-product_id="<?php echo $products->get_id (); ?>"
                                data-product_sku="<?php echo $products->get_sku (); ?>"
                                class="ajax_add_to_cart add_to_cart_button wceazy_psb_add_to_cart_btn">Add To
                            Cart</a>
                    <?php } ?>
                </div>
