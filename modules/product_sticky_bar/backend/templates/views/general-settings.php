    <div class="tab_body_title">
        <h1><?php _e ('Bar Settings', 'wceazy'); ?></h1>
    </div>

    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Enable Sticky Bar', 'wceazy'); ?></h4>
        </div>
    ...
    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Show on Desktop', 'wceazy'); ?></h4>
        </div>
    ...
    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Show on Mobile', 'wceazy'); ?></h4>
        </div>
    ...
    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Sticky Bar Position', 'wceazy'); ?></h4>
        </div>
        <div class="label_content">
            <select name="wfpsb_show_in" id="wfpsb_show_in" class="wceazy_select_control wceazy_select2">
                <option value=""> Please select</option>
                <option <?php echo !empty($this->settings) && isset($this->settings->wfpsb_show_in) && $this->settings->wfpsb_show_in == 'before' ? 'selected':''; ?> value="before"><?php _e ('Top', 'wceazy'); ?></option>
                <option <?php echo !empty($this->settings) && isset($this->settings->wfpsb_show_in) && $this->settings->wfpsb_show_in == 'after' ? 'selected':''; ?> value="after"><?php _e ('Bottom', 'wceazy'); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Show Only After Scroll', 'wceazy'); ?></h4>
        </div>
    ...
    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Scroll Pixels', 'wceazy'); ?></h4>
        </div>

        <div class="label_content">
            <div class="wceazy_module_list_items">
                <div class="label_content">
                    <input onkeyup="removeChar(this);" class="wceazy_text_control wfpsb_input" type="text" value="<?php echo !empty($this->settings) && isset($this->settings->wfpbs_scroll_pixels) ? $this->settings->wfpbs_scroll_pixels : 180; ?>"
    ...
    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Show Product Review', 'wceazy'); ?></h4>
        </div>
        <div class="label_content">
            <div class="wceazy_module_list_items">
                <div class="wceazy_module_item">
    ...
    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Show Product Review Count', 'wceazy'); ?></h4>
        </div>
    ...
    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Disable for', 'wceazy'); ?> <span class="wceazy_get_pro">(Pro)</span></h4>
        </div>
        <div class="label_content">
            <div class="wceazy_module_list_items">
                <select id="wfpsb_disabled_products" class="wceazy_select_control wceazy_select2" data-placeholder="Please Select" disabled>
                    <option value=""> Please select</option>
                </select>
            </div>
    ...
    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Enable Update Product Qty', 'wceazy'); ?></h4>
        </div>
...
<!--    <div class="wceazy_form_group sticky_settings_bar f-baseline">-->
<!--        <div class="label_title">-->
<!--            <h4>--><?php //_e ('Enable Variable Product', 'wceazy'); ?><!--</h4>-->
<!--        </div>-->
<!---->
<!--        <div class="label_content">-->
<!--            <div class="wceazy_module_list_items">-->
...
<!--    </div>-->
    ...
    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Show Product Image', 'wceazy'); ?></h4>
        </div>
    ...
    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Show Stock Status', 'wceazy'); ?></h4>
        </div>
    ...
    <div class="wceazy_form_group sticky_settings_bar f-baseline">
        <div class="label_title">
            <h4><?php _e ('Hide Sticky bar( <small>Product Out of Stock</small> )', 'wceazy'); ?></h4>
        </div>
