...
function wceazy_bogo_deal_init(){
    jQuery('#wceazy_bogo_deal_header').show();
    jQuery('#wceazy_bogo_deal_container').show();
...
function wceazy_bogo_deal_save_rules(view) {
    ...
    console.log(JSON.stringify(wceazy_bogo_deal_rules))
