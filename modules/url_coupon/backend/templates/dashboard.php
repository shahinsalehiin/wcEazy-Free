<div id="wceazy_url_coupon_header" style="display: none;">
    <div class="wceazy_url_coupon_module_list_header">
        <div class="wceazy_url_coupon_module_left_header">
            <p><?php _e('wcEazy<span>'.WCEAZY_VERSION.'</span>','wceazy') ?></p>
        </div>
        <div class="wceazy_url_coupon_module_right_header">
            <p class="get_pro">
                <a href="https://wceazy.com" target="_blank">Get Pro</a>
            </p>
        </div>
    </div>
    <div class="wceazy_url_coupon_single_module_title">
...
<div id="wceazy_url_coupon_container" style="display: none;">
