    ...
    <div class="wceazy-url-coupon-options-group">
        ...
        woocommerce_wp_checkbox (
            array(
                ...
                'label' => __ ('Active Coupon URL', 'wceazy'),
                'class' => 'wceazy-url-coupon-toggle',
                'description' => __ ('When checked, enable coupon URL functionality for this coupon.', 'wceazy'),
        ...
        woocommerce_wp_checkbox (
            array(
                ...
                'label' => __ ('Force Apply', 'wceazy'),
                'class' => 'wceazy-url-coupon-force-apply',
                'description' => __ ('When checked, remove all the other coupons and apply the current coupon on cart items.', 'wceazy'),
        ...
        woocommerce_wp_text_input (
            array(
                ...
                'label' => __ ('Coupon URL', 'wceazy'),
                'class' => 'wceazy-url-coupon-url',
                'description' => __ ('<span class="wceazy-desc-url-coupon-url">When visited, the coupon code will be applied to the visitor’s cart automatically.</span> <span class="wceazy-copy-url-coupon-url">Copy URL</span>', 'wceazy'),
                'type' => 'text',
                'data_type' => 'text',
        ...
        woocommerce_wp_text_input (
            array(
                ...
                'label' => __ ('Override URL Code <span class="wceazy_get_pro">(Pro)</span>', 'wceazy'),
                'class' => '',
                'description' => __ ('Customize the coupon code on the coupon url. Leave blank to disable feature.', 'wceazy'),
                'type' => 'text',
                'data_type' => 'text',
                'desc_tip' => true,
                'value' => '',
        ...
        woocommerce_wp_text_input (
            array(
                ...
                'label' => __ ('Redirect To URL', 'wceazy'),
                'description' => __ ("This will redirect the user to the provided URL after it has been attempted to be applied. You can also pass query args to the URL for the following variables: {test}, {yes} or {errormessage} and they will be replaced with proper data. Eg. ?foo={error_message}, then test the 'foo' query arg to get the message if there is one.", 'wceazy'),
                'desc_tip' => true,
                'type' => 'text',
                'data_type' => 'text',
        ...
        woocommerce_wp_textarea_input (
            array(
                ...
                'label' => __ ('Success Message <span class="wceazy_get_pro">(Pro)</span>', 'wceazy'),
                'description' => __ ('Message that will be displayed when a coupon has been applied successfully. Leave blank to use the default message.', 'wceazy'),
                'desc_tip' => true,
                'type' => 'textarea',
                'data_type' => 'text',
                'placeholder' => __ ('Coupon applied successfully', 'wceazy'),
                'value' => '',
                'custom_attributes' => array('readonly' => true, 'disabled' => true),
            )
        );
