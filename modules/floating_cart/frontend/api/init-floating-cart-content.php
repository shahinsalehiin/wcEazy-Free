...
if ($this->base_admin->base_admin->db->getModuleStatus($this->base_admin->module_slug)) {
    ...
    check_ajax_referer('wceazyfcf_hashkey', 'security');
	...
	<div id="wceazy-fct-body" class="wceazy-fct-wrap">
		<div class="wceazy-fct-content-wrap">

			<div class="wceazy-fct-content">

				<div class="wceazy-fct-loader" style="display: none;">
					<p>Cart updating..</p>
					<img src="<?php echo WCEAZY_IMG_DIR . 'popup_spinner.svg'; ?>"
					     alt="wceazy foloating cart loader">
				</div>

				<header class="fct-header">

					<div class="wceazy-fct-notice wceazy-fct-success" style="display: none;"></div>


					<div class="wceazy-fct-left-header wffc-d-flex">
                        <?php
                        if (!empty($this->wfc_settings) && isset($this->wfc_settings['wffc_show_header_basket_icon'])) { ?>
							<span class="wceazy-cart-icon" data-cart_icon="demo-icon icon-basket6">
				...
				<div class="wceazy-fct-items-and-footer">
                    <div class="wffc-appply-coupon-loader" style="display: none;">
                        <img src="<?php echo WCEAZY_IMG_DIR . 'popup_spinner.svg'; ?>" alt="wceazy apply coupon loader">
                    </div>
						...
						<ul>
							...
							<li style="display: none;" class="wffc-empty-cart-content wfct-button">
								<p>
                                    ...
                                    _e($wffc_empty_cart_message, 'wceazy');
                                    ?>
								</p>
                            ...
                            foreach ($wffc_carts as $cart_item_key => $cart_item) {
                                ...
                                <?php }else{ ?>
                                    ...
                                    <li class="wceazy-fct-item-<?php echo $product_id; ?>">
                                            ...
                                            <div class="fct-cart-product">
                                                ...
                                                if (!empty($this->wfc_settings) && isset($this->wfc_settings['wffc_allowed_quantity_update'])) { ?>
                                                    <div class="fct-cart-product-qt">
                                                        <input type="button" class="wceazy-fct-decrement-pqty" value="-"
                                                               data-product_id="<?php echo $product_id; ?>"
                                                               data-cart_item_key="<?php echo $cart_item_key ?>"/>
                                                        <input class="wceazy-fct-pqty-<?php echo $product_id; ?>" data-product_id="<?php echo $product_id; ?>" data-cart_item_key="<?php echo $cart_item_key ?>"
                                                               type="text" name="quantity" onblur="wceazy_qty_update(this);"
                                                               value="<?php echo $cart_item['quantity']; ?>" maxlength="2"
                                                               max="100" size="1"
                                                               id="number"/>
                                                        <input type="button" class="wceazy-fct-increment-pqty"
                                                               data-product_id="<?php echo $product_id; ?>"
                                        ...
                                        <div class="fct-product-action">
                                            ...
                                            if (!empty($this->wfc_settings) && isset($this->wfc_settings['wffc_delete_item_form_cart'])) {
                                                ...
                                                ?>
                                                <button class="wceazy-fct-remove-item"
                                                        data-product_id="<?php echo $product_id; ?>"
                                                        data-cart_item_key="<?php echo $cart_item_key ?>">
                                            ...
                                            <div class="fct-product-price">
                                                ...
                                                if (!empty($this->wfc_settings) && isset($this->wfc_settings['wffc_show_product_price_total'])) {
                                                    ?>
                                                    <p class="wceazy-fct-psubtotal-<?php echo $product_id; ?>"><?php echo $product_subtotal; ?></p>
                                                <?php } else { ?>
                                                    <p class="wceazy-fct-psubtotal-<?php echo $product_id; ?>"><?php echo $product_price; ?></p>
                                                <?php }
                                                ?>
                                            </div>
				...
				<footer class="fct-footer">
						...
						<section class="fct-subtotal">
							<ul>
								<li>
									...
									<div class="total-amount wceazy-fct-cartsubtotal"><?php echo WC()->cart->get_cart_subtotal(); ?></div>
								</li>
							</ul>
						</section>
                    <?php }
						...
						<section class="fct-shipping-amount">
							<ul>
								<li>
									...
									<div class="total-amount wceazy-fct-shippingtotal"><?php echo $shippingTotal == 'Free!' ? '0.00$' : $shippingTotal; ?></div>
								</li>
							</ul>
						</section>
                    <?php }
                    ...
                    if (!empty($this->wfc_settings) && isset($this->wfc_settings['wffc_show_cart_total'])) { ?>
						<ul>
							<li>
								...
								<div class="total-amount wceazy-fct-carttotal"><?php echo WC()->cart->get_total(); ?></div>
							</li>
						</ul>
                    <?php } ?>
					...
					<div class="fct-continue-shopping wfct-button">
						...
						<a href="<?php echo $wffc_continue_btn_url; ?>" target="_blank">
                            ...
                            _e($wffct_continue_btn_text, 'wceazy');
                            ?>
