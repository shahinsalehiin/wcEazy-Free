<div class="tab_body_title">
    <h1><?php _e( 'Body Settings', 'wceazy' ); ?></h1>
</div>
...
<div class="wceazy_form_group floating_cart_settings_bar">
    <div class="label_title">
        <h4><?php _e( 'Show Product Name?', 'wceazy' ); ?></h4>
    </div>
...
<div class="wceazy_form_group floating_cart_settings_bar">
    <div class="label_title">
        <h4><?php _e( 'Show Product Unit Price?', 'wceazy' ); ?></h4>
    </div>
...
<div class="wceazy_form_group floating_cart_settings_bar">
    <div class="label_title">
        <h4><?php _e( 'Show Product Price Total?', 'wceazy' ); ?></h4>
    </div>
...
<!--<div class="wceazy_form_group floating_cart_settings_bar">-->
<!--    <div class="label_title">-->
<!--        <h4>--><?php //_e( 'Show Product Meta?', 'wceazy' ); ?><!--</h4>-->
<!--    </div>-->
<!---->
<!--    <div class="label_content">-->
<!--        <div class="wceazy_module_list_items">-->
...
<!--<div class="wceazy_form_group floating_cart_settings_bar">-->
<!--    <div class="label_title">-->
<!--        <h4>--><?php //_e( 'Show Product Sale Count?', 'wceazy' ); ?><!--</h4>-->
<!--    </div>-->
<!---->
<!--    <div class="label_content">-->
<!--        <div class="wceazy_module_list_items">-->
...
<div class="wceazy_form_group floating_cart_settings_bar">
    <div class="label_title">
        <h4><?php _e( 'Link to Single Product?', 'wceazy' ); ?></h4>
    </div>
...
<div class="wceazy_form_group floating_cart_settings_bar">
    <div class="label_title">
        <h4><?php _e( 'Delete Item From Cart', 'wceazy' ); ?></h4>
    </div>
...
<div class="wceazy_form_group floating_cart_settings_bar">
    <div class="label_title">
        <h4><?php _e( 'Allowed Quantity Update', 'wceazy' ); ?></h4>
    </div>
...
<!--<div class="wceazy_form_group floating_cart_settings_bar">-->
<!--    <div class="label_title">-->
<!--        <h4>--><?php //_e( 'Show Variable Product Name?', 'wceazy' ); ?><!--</h4>-->
<!--    </div>-->
<!---->
<!--    <div class="label_content">-->
<!--        <div class="wceazy_module_list_items">-->
