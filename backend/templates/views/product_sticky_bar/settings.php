...
<div id="wceazy_product_sticky_bar">
    ...
    <div class="wceazy_product_sticky_bar_page_title">
        ...
        <div class="page_title_part_right">
            <button class="wceazy_product_sticky_bar_back_to_dashboard_btn" onclick="wceazy_modules_page_init(`<?php echo esc_url(WCEAZY_URL); ?>`)"><?php esc_html_e('Back to all Modules', 'wceazy') ?></button>
        </div>
    </div>
                ...
                <div class="coupon_tab_body" data-id="tab_settings">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_show_on_desktop">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Show on Desktop', 'wceazy') ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_show_on_mobile">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Show on Mobile', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_show_in">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Sticky Bar Position', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_product_sticky_bar_select_field">
                                    <option value=""><?php esc_html_e('Please select', 'wceazy'); ?></option>
                                    <option value="top" <?php echo esc_attr($wceazy_psb_show_in == "top" ? "selected" : ""); ?>><?php esc_html_e('Top', 'wceazy'); ?></option>
                                    <option value="bottom" <?php echo esc_attr($wceazy_psb_show_in == "bottom" ? "selected" : ""); ?>><?php esc_html_e('Bottom', 'wceazy'); ?></option>
                                </select>
                            </div>
                        </div>

                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_show_only_scroll">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Show Only After Scroll', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <label class="toggle_switch">
                                    <input type="checkbox" <?php echo esc_attr($wceazy_psb_show_only_scroll == "yes" ? "checked" : ""); ?>>
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_product_review">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Show Product Review', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <label class="toggle_switch">
                                    <input type="checkbox" <?php echo esc_attr($wceazy_psb_product_review == "yes" ? "checked" : ""); ?>>
                                    <span class="slider round"></span>
                                </label>
                                <small><?php esc_html_e('Please turn off if you don\'t want to show product review', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_product_review_count">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Show Product Review Count', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <label class="toggle_switch">
                                    <input type="checkbox" <?php echo esc_attr($wceazy_psb_product_review_count == "yes" ? "checked" : ""); ?>>
                                    <span class="slider round"></span>
                                </label>
                                <small><?php esc_html_e('Please turn off if you don\'t want to show product review count', 'wceazy'); ?></small>
                            </div>
                        </div>
                            ...
                            <div class="field_with_msg_container">
                                <select class="wceazy_product_sticky_bar_select_field" multiple="multiple" disabled>
                                    ...
                                    <?php foreach ($this->product_sticky_bar->utils->getWooProducts() as $product) { ?>
                                        <option value="<?php echo esc_attr($product["id"]); ?>" <?php echo esc_attr(in_array($product["id"], $wceazy_psb_disabled_products) ? "selected" : ""); ?>>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_enable_qty_input">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Enable Update Product Qty', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html_e('Please turn off if you don\'t want to show product quantity update option on sticky bar', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_enable_variable_product">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Enable Variable Product', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html_e('Please turn off if you don\'t want to show variable product selection option on sticky bar', 'wceazy'); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_show_product_image">
                            ...
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html_e('Please turn off if you don\'t want to show product image on sticky bar', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_show_stock">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Show Stock Status', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_hidebar_outofstock">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Hide Sticky bar (Product Out of Stock)', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html_e('Please turn on if you don\'t want to show sticky bar when the product is out of stock', 'wceazy'); ?></small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="coupon_tab_body" data-id="tab_style">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_product_image_shape">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Product Image Shape', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_product_sticky_bar_select_field">
                                    <option value=""> Please select</option>
                                    <option value="round" <?php echo esc_attr($wceazy_psb_product_image_shape == "round" ? "selected" : ""); ?>><?php esc_html_e('Round', 'wceazy'); ?></option>
                                    <option value="square" <?php echo esc_attr($wceazy_psb_product_image_shape == "square" ? "selected" : ""); ?>><?php esc_html_e('Square', 'wceazy'); ?></option>
                                </select>
                                <small><?php esc_html_e('Select Product image shape. Default: Square', 'wceazy'); ?></small>
                            </div>
                        </div>


                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_product_title_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Product Title Color ', 'wceazy'); ?><span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_product_sticky_bar_product_title_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_product_rating_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Product Rating Color ', 'wceazy'); ?><span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_product_sticky_bar_product_rating_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_product_rating_count_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Product Rating Count Color', 'wceazy'); ?> <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_product_sticky_bar_product_rating_count_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_product_price_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Product Price Color', 'wceazy'); ?> <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_product_sticky_bar_product_price_color"><?php esc_html_e('Select Color', 'wceazy'); ?><?php esc_html_e('', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_product_price_font_size">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Product Price Font Size', 'wceazy'); ?><?php esc_html_e('', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_btn_bg_color">
                            ...
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_product_sticky_bar_btn_bg_color"><?php esc_html_e('Select Color', 'wceazy'); ?><?php esc_html_e('', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_btn_font_color">
                            ...
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_product_sticky_bar_btn_font_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_btn_border_color">
                            ...
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_product_sticky_bar_btn_border_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_btn_border_width">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Button Border Width', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_btn_bg_hover_color">
                            ...
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_product_sticky_bar_btn_bg_hover_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_btn_border_hover_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Button Border Hover Color', 'wceazy'); ?> <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_product_sticky_bar_btn_border_hover_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_btn_font_hover_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Button Hover Font Color', 'wceazy'); ?> <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_product_sticky_bar_btn_font_hover_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_product_sticky_bar_field_group wceazy_product_sticky_bar_btn_padding_top_bottom">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Button Padding Top-Bottom', 'wceazy'); ?> <span style="color: #FF521D;"><?php esc_html_e('(Pro)', 'wceazy'); ?></span></label>
                            <div class="field_with_msg_container">
