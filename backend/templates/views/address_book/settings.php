...
<div id="wceazy_address_book">
    ...
    <div class="wceazy_address_book_header">
        ...
        <div class="wceazy_header_part_right">
            <a class="wceazy_get_pro" target="_blank" href="<?php echo esc_attr(WCEAZY_GET_PRO_URL); ?>"><?php esc_html__('GET PRO', 'wceazy') ?></a>
        </div>
    </div>
    ...
    <div class="wceazy_address_book_page_title">
        <div class="page_title_part_left">
            <h2><?php esc_html__('Address Book', 'wceazy') ?></h2>
            <a target="_blank" href="<?php echo esc_attr(WCEAZY_DOCS_PAGE); ?>"><?php esc_html__('Documentation', 'wceazy') ?></a>
        </div>
        <div class="page_title_part_right">
            <button class="wceazy_address_book_back_to_dashboard_btn" onclick="wceazy_modules_page_init(`<?php echo esc_url(WCEAZY_URL); ?>`)"><?php esc_html__('Back to all Modules', 'wceazy') ?></button>
        </div>
    </div>
    ...
    <div class="wceazy_address_book_container">
            ...
            <div class="wceazy_address_book_tab_part_left">
                <div class="coupon_data_tabs">
                    <div class="tab_item tab_item_active" data-target="tab_general">
                        <h1><?php esc_html__('General', 'wceazy') ?></h1>
                    </div>
                    <div class="tab_item" data-target="tab_typography">
                        <h1><?php esc_html__('Typography', 'wceazy') ?></h1>
                    </div>
                    <div class="tab_item" data-target="tab_styles">
                        <h1><?php esc_html__('Styles', 'wceazy') ?></h1>
                    </div>
                </div>
            </div>
            ...
            <div class="wceazy_address_book_tab_part_right">
                ...
                <div class="coupon_tab_body" data-id="tab_general">
                    <div class="tab_body_title">
                        <h1><?php esc_html__('General Settings', 'wceazy') ?></h1>
                    </div>
                    <div class="tab_body_form">


                        <h4><?php esc_html__('Account Contacts', 'wceazy') ?></h4>

                        <div class="wceazy_address_book_field_group wceazy_address_book_enable_billing_address_book">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Set Up Billing Address List', 'wceazy') ?></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html__('Turn ON the switch to enable address book for billing.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_enable_shipping_address_book">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Use "Save Addresses for Shipping."', 'wceazy') ?></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html__('Flip the switch to use the address book for shipping.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <h4><?php esc_html__('Checkout Address', 'wceazy') ?></h4>

                        <div class="wceazy_address_book_field_group wceazy_address_book_enable_billing_address_book_checkout">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Checkout Address?', 'wceazy') ?></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html__('"Switch ON to pick your billing address at checkout."', 'wceazy') ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_enable_shipping_address_book_checkout">
                            ...
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html__('Flip the switch to choose your shipping address at checkout.', 'wceazy') ?></small>
                            </div>
                        </div>
                ...
                <div class="coupon_tab_body" data-id="tab_typography">
                    <div class="tab_body_title">
                        <h1><?php esc_html__('Typography Settings', 'wceazy') ?></h1>
                    </div>
                    <div class="tab_body_form">

                        <h4><?php esc_html__('Checkout Page', 'wceazy') ?></h4>

                        <div class="wceazy_address_book_field_group wceazy_address_book_checkout_field_label">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Address Field Label', 'wceazy') ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_address_book_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_ab_checkout_field_label); ?>">
                                <small><?php esc_html__('Change the label text for the address field on the checkout page.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <h4><?php esc_html__('Account Page', 'wceazy') ?></h4>

                        <div class="wceazy_address_book_field_group wceazy_address_book_menu_title">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Menu Title', 'wceazy') ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_address_book_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_ab_menu_title); ?>">
                                <small><?php esc_html__('Set the account page menu title for Address Book.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_billing_headline_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Billing Address Book Headline', 'wceazy') ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_address_book_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_ab_billing_headline_text); ?>">
                                <small><?php esc_html__('Set the headline text of billing address book.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_shipping_headline_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Shipping Address Book Headline', 'wceazy') ?></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html__('Set the headline text of shipping address book.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_billing_add_btn_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Add Billing Address Button Text ', 'wceazy') ?><span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html__('Set the button text of add new billing address.', 'wceazy') ?></small>
                            </div>
                        </div>


                        <div class="wceazy_address_book_field_group wceazy_address_book_shipping_add_btn_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Add Shipping Address Button Text', 'wceazy') ?> <span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html__('Set the button text of add new shipping address.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_billing_empty_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Billing Address Book Empty Message ', 'wceazy') ?><span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html__('Set the empty message text of billing address book.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_shipping_empty_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Shipping Address Book Empty Message', 'wceazy') ?> <span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html__('Set the empty message text of shipping address book.', 'wceazy') ?></small>
                            </div>
                        </div>


                        <div class="wceazy_address_book_field_group wceazy_address_book_edit_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Address Edit Link Text', 'wceazy') ?> <span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                <input disabled class="wceazy_address_book_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_ab_edit_text); ?>">
                                <small><?php esc_html__('Set the address edit link text.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_delete_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Address Delete Link Text', 'wceazy') ?> <span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                <input disabled class="wceazy_address_book_text_field" type="text" placeholder="" value="<?php echo esc_attr($wceazy_ab_delete_text); ?>">
                                <small><?php esc_html__('Set the address delete link text.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_make_primary_text">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Address Make Primary Link Text ', 'wceazy') ?><span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html__('Set the address make primary link text.', 'wceazy') ?></small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="coupon_tab_body" data-id="tab_styles">
                    <div class="tab_body_title">
                        <h1><?php esc_html__('Customize Styles', 'wceazy') ?></h1>
                    </div>
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_add_btn_bg_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Add Button Background Color ', 'wceazy') ?><span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_address_book_add_btn_bg_color"><?php esc_html__('Select Color', 'wceazy') ?></label>
                                </div>
                                <small><?php esc_html__('Set the add new button background color.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_add_btn_text_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Add Button Text Color', 'wceazy') ?> <span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input disabled type="color" id="wceazy_address_book_add_btn_text_color" value="<?php echo esc_attr($wceazy_ab_add_btn_text_color); ?>">
                                    <label for="wceazy_address_book_add_btn_text_color"><?php esc_html__('Select Color', 'wceazy') ?></label>
                                </div>
                                <small><?php esc_html__('Set the add new button text color.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_add_btn_bg_hover_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Change the color when you hover over the "Add" button.', 'wceazy') ?> <span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_address_book_add_btn_bg_hover_color"><?php esc_html__('Select Color', 'wceazy') ?></label>
                                </div>
                                <small><?php esc_html__('Set the add new button background color on hover.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_add_btn_text_hover_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Add Button Text Hover Color', 'wceazy') ?> <span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_address_book_add_btn_text_hover_color"><?php esc_html__('Select Color', 'wceazy') ?></label>
                                </div>
                                <small><?php esc_html__('Set the add new button text color on hover.', 'wceazy') ?></small>
                            </div>
                        </div>


                        <div class="wceazy_address_book_field_group wceazy_address_book_add_btn_border_hover_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Add Button Border Hover Color ', 'wceazy') ?><span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_address_book_add_btn_border_hover_color"><?php esc_html__('Select Color', 'wceazy') ?></label>
                                </div>
                                <small><?php esc_html__('Set the add new button border color on hover.', 'wceazy') ?></small>
                            </div>
                        </div>
                        ...
                        <div class="wceazy_address_book_field_group wceazy_address_book_card_bg_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Address Card Background Color', 'wceazy') ?> <span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input disabled type="color" id="wceazy_address_book_card_bg_color" value="<?php echo esc_attr($wceazy_ab_card_bg_color); ?>">
                                    <label for="wceazy_address_book_card_bg_color"><?php esc_html__('Select Color', 'wceazy') ?></label>
                                </div>
                                <small><?php esc_html__('Set the background color of address card.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_card_border_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Address Card Border Color', 'wceazy') ?> <span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input disabled type="color" id="wceazy_address_book_card_border_color" value="<?php echo esc_attr($wceazy_ab_card_border_color); ?>">
                                    <label for="wceazy_address_book_card_border_color"><?php esc_html__('Select Color', 'wceazy') ?></label>
                                </div>
                                <small><?php esc_html__('Set the border color of address card.', 'wceazy') ?></small>
                            </div>
                        </div>

                        <div class="wceazy_address_book_field_group wceazy_address_book_card_text_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Address Text Color ', 'wceazy') ?><span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input disabled type="color" id="wceazy_address_book_card_text_color" value="<?php echo esc_attr($wceazy_ab_card_text_color); ?>">
                                    <label for="wceazy_address_book_card_text_color"><?php esc_html__('Select Color', 'wceazy') ?></label>
                                </div>
                                <small><?php esc_html__('Set the text color of address inside address card.', 'wceazy') ?></small>
                            </div>
                        </div>
                        <div class="wceazy_address_book_field_group wceazy_address_book_card_footer_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Card Bottom Color', 'wceazy') ?> <span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input disabled type="color" id="wceazy_address_book_card_footer_color" value="<?php echo esc_attr($wceazy_ab_card_footer_color); ?>">
                                    <label for="wceazy_address_book_card_footer_color"><?php esc_html__('Select Color', 'wceazy') ?></label>
                                </div>
                                <small><?php esc_html__('Set the footer background color of address card.', 'wceazy') ?></small>
                            </div>
                        </div>


                        <div class="wceazy_address_book_field_group wceazy_address_book_card_link_text_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html__('Address Card Link Text Color', 'wceazy') ?> <span style="color: #FF521D;"><?php esc_html__('(Pro)', 'wceazy') ?></span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_address_book_card_link_text_color"><?php esc_html__('Select Color', 'wceazy') ?></label>
                                </div>
                                <small><?php esc_html__('Set the link text color of address card.', 'wceazy') ?></small>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="wceazy_address_book_bottom_button_section">
            <button onclick="wceazy_address_book_save();"><?php esc_html__('Save Settings', 'wceazy') ?></button>
        </div>
