...
<div id="wceazy_floating_cart">
    ...
    <div class="wceazy_floating_cart_page_title">
        ...
        <div class="page_title_part_right">
            <button class="wceazy_floating_cart_back_to_dashboard_btn" onclick="wceazy_modules_page_init(`<?php echo esc_url(WCEAZY_URL); ?>`)"><?php esc_html_e('Back to all Modules', 'wceazy'); ?></button>
        </div>
    </div>
                ...
                <div class="coupon_tab_body" data-id="tab_general">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_auto_open_cart">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Is Auto Open Cart?', 'wceazy'); ?></label>
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_bascket_count">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Basket Count', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_floating_cart_select_field">
                                    <option value=""> <?php esc_html_e('Please select', 'wceazy'); ?></option>
                                    <option value="number_of_products" <?php echo esc_attr("number_of_products" == $wceazy_fc_bascket_count ? "selected" : ""); ?>> <?php esc_html_e('Number Of Products', 'wceazy'); ?> </option>
                                    <option value="number_of_items" <?php echo esc_attr("number_of_items" == $wceazy_fc_bascket_count ? "selected" : ""); ?>> <?php esc_html_e('Total Number Of Items', 'wceazy'); ?> </option>
                                </select>
                            </div>
                        </div>

                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_dont_show_cart_pages">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Select Don\'t Show Pages', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                ...
                <div class="coupon_tab_body" data-id="tab_typography">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_heading_title">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Heading Title', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                ...
                <div class="coupon_tab_body" data-id="tab_redirect_urls">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_view_cart_btn_url">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('View Cart Button Url', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_checkout_btn_url">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('View Checkout Button Url', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                ...
                <div class="coupon_tab_body" data-id="tab_general_style">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_width">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Cart Width(px)', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_open_from">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Cart Open From', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <select class="wceazy_floating_cart_select_field">
                                    <option value=""><?php esc_html_e('Please select', 'wceazy'); ?></option>
                                    <option value="left" <?php echo esc_attr("left" == $wceazy_fc_open_from ? "selected" : ""); ?>><?php esc_html_e('Left', 'wceazy'); ?></option>
                                    <option value="right" <?php echo esc_attr("right" == $wceazy_fc_open_from ? "selected" : ""); ?>><?php esc_html_e('Right', 'wceazy'); ?></option>
                                </select>
                            </div>
                        </div>

                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_btn_font_size">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Button Font Size', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_btn_font_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Button Font Color', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_floating_cart_btn_font_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_btn_bg_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Button Background Color', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input disabled type="color" id="wceazy_floating_cart_btn_bg_color" value="<?php echo esc_attr($wceazy_fc_btn_bg_color); ?>">
                                    <label for="wceazy_floating_cart_btn_bg_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_btn_hover_font_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Button Hover Font Color', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_floating_cart_btn_hover_font_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_btn_hover_bg_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Button Hover Background', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_floating_cart_btn_hover_bg_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_btn_border_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Button Border Color', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    <input disabled type="color" id="wceazy_floating_cart_btn_border_color" value="<?php echo esc_attr($wceazy_fc_btn_border_color); ?>">
                                    <label for="wceazy_floating_cart_btn_border_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_btn_border_hover_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Button Border Hover Color', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_floating_cart_btn_border_hover_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_btn_border_radius">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Button Border Radius', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                ...
                <div class="coupon_tab_body" data-id="tab_header_style">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_cross_icon_size">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Cross Icon Size(px)', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_header_basket_icon_size">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Heading Basket Icon Size(px)', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_heading_font_size">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Heading Font Size(px)', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_heading_font_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Heading Font Color', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_floating_cart_heading_font_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_heading_border_bottom_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Heading Border Bottom Color', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_floating_cart_heading_border_bottom_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                ...
                <div class="coupon_tab_body" data-id="tab_content_style">
                    ...
                    <div class="tab_body_form">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_item_remove_icon">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Product Remove Icon', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_remove_icon_size">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Product Remove Icon Size(px)', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_product_img_width">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Product Image Width', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                        ...
                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_product_title_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Product Title Color', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_floating_cart_product_title_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>

                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_product_title_font_size">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Product Title Font Size', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                ...
                                <small><?php esc_html_e('Set your cart content product title font size in px (Ex. 16)', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_quantity_box_width">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Quantity Box Width', 'wceazy'); ?></label>
                            <div class="field_with_msg_container">
                                <input class="wceazy_floating_cart_text_field" type="number" placeholder="" value="<?php echo esc_attr($wceazy_fc_quantity_box_width); ?>">
                                <small><?php esc_html_e('Set your cart content product quantity input box width in px (Ex. 56)', 'wceazy'); ?></small>
                            </div>
                        </div>

                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_quantity_box_border_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Quantity Box Border Color', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_floating_cart_quantity_box_border_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>

                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_quantity_box_bg_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Quantity Box Background Color', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_floating_cart_quantity_box_bg_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>

                        <div class="wceazy_floating_cart_field_group wceazy_floating_cart_quantity_box_text_color">
                            <label for="coupon_generator_coupon_amount"><?php esc_html_e('Quantity Box Text Color', 'wceazy'); ?> <span style="color: #FF521D;">(Pro)</span></label>
                            <div class="field_with_msg_container">
                                <div class="color_picker_area">
                                    ...
                                    <label for="wceazy_floating_cart_quantity_box_text_color"><?php esc_html_e('Select Color', 'wceazy'); ?></label>
                                </div>
                            </div>
                        </div>
