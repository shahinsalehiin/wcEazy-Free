        ...
        <div class="wceazy_module_item" data-slug="auto_apply_coupon">
            ...
            <div class="wceazy_module_details">
                ...
                <div class="wceazy_module_action">
                    ...
                    <div class="settings_btn <?php echo ($this->settings->getModuleStatus("auto_apply_coupon") == 1 ? "active" : ""); ?>" onclick="wceazy_start_module_settings(`<?php echo esc_url(WCEAZY_URL); ?>`, this)">
        ...
        <div class="wceazy_module_item" data-slug="bogo_deal">
            ...
            <div class="wceazy_module_details"> 
                ...
                <div class="wceazy_module_action">
                    ...
                    <div class="settings_btn <?php echo ($this->settings->getModuleStatus("bogo_deal") == 1 ? "active" : ""); ?>" onclick="wceazy_start_module_settings(`<?php echo esc_url(WCEAZY_URL); ?>`, this)">
                        <?php esc_html_e('Settings', 'wceazy'); ?>
                    </div>
                    <a class="wceazy_module_docs" target="_blank" href="<?php echo WCEAZY_DOCS_PAGE; ?>"><?php esc_html_e('Documentation', 'wceazy'); ?></a>
                </div>
        ...
        <div class="wceazy_module_item" data-slug="coupon_generator">
            ...
            <div class="wceazy_module_details">
                ...
                <div class="wceazy_module_action">
                    ...
                    <div class="settings_btn <?php echo ($this->settings->getModuleStatus("coupon_generator") == 1 ? "active" : ""); ?>" onclick="wceazy_start_module_settings(`<?php echo esc_url(WCEAZY_URL); ?>`, this)">
                        <?php esc_html_e(' Settings', 'wceazy'); ?>
                    </div>
                    <a class="wceazy_module_docs" target="_blank" href="<?php echo WCEAZY_DOCS_PAGE; ?>"><?php esc_html_e('Documentation', 'wceazy'); ?></a>
                </div>
        ...
        <div class="wceazy_module_item" data-slug="url_coupon">
            ...
            <div class="wceazy_module_details">
                ...
                <div class="wceazy_module_action">
                    ...
                    <div class="settings_btn <?php echo ($this->settings->getModuleStatus("url_coupon") == 1 ? "active" : ""); ?>" onclick="wceazy_start_module_settings(`<?php echo esc_url(WCEAZY_URL); ?>`, this)">
                        <?php esc_html_e('Settings', 'wceazy'); ?>
                    </div>
                    <a class="wceazy_module_docs" target="_blank" href="<?php echo WCEAZY_DOCS_PAGE; ?>"><?php esc_html_e('Documentation', 'wceazy'); ?></a>
                </div>
        ...
        <div class="wceazy_module_item" data-slug="product_sticky_bar">
            ...
            <div class="wceazy_module_details">
                ...
                <div class="wceazy_module_action">
                    ...
                    <div class="settings_btn <?php echo ($this->settings->getModuleStatus("product_sticky_bar") == 1 ? "active" : ""); ?>" onclick="wceazy_start_module_settings(`<?php echo esc_url(WCEAZY_URL); ?>`, this)">
                        <?php esc_html_e(' Settings', 'wceazy'); ?>
                    </div>
                    <a class="wceazy_module_docs" target="_blank" href="<?php echo WCEAZY_DOCS_PAGE; ?>"><?php esc_html_e('Documentation', 'wceazy'); ?>'</a>
                </div>
        ...
        <div class="wceazy_module_item" data-slug="one_click_checkout">
            ...
            <div class="wceazy_module_details">
                ...
                <div class="wceazy_module_action">
                    ...
                    <div class="settings_btn <?php echo ($this->settings->getModuleStatus("one_click_checkout") == 1 ? "active" : ""); ?>" onclick="wceazy_start_module_settings(`<?php echo esc_url(WCEAZY_URL); ?>`, this)">
                        <?php esc_html_e('Settings', 'wceazy'); ?>
                    </div>
                    <a class="wceazy_module_docs" target="_blank" href="<?php echo WCEAZY_DOCS_PAGE; ?>"><?php esc_html_e('Documentation', 'wceazy'); ?></a>
                </div>
        ...
        <div class="wceazy_module_item" data-slug="floating_cart">
            ...
            <div class="wceazy_module_details">
                ...
                <div class="wceazy_module_action">
                    ...
                    <div class="settings_btn <?php echo ($this->settings->getModuleStatus("floating_cart") == 1 ? "active" : ""); ?>" onclick="wceazy_start_module_settings(`<?php echo esc_url(WCEAZY_URL); ?>`, this)">
                        <?php esc_html_e(' Settings', 'wceazy'); ?>
                    </div>
                    <a class="wceazy_module_docs" target="_blank" href="<?php echo WCEAZY_DOCS_PAGE; ?>"><?php esc_html_e('Documentation', 'wceazy'); ?></a>
                </div>
        ...
        <div class="wceazy_module_item" data-slug="pdf_invoice">
            ...
            <div class="wceazy_module_details">
                ...
                <div class="wceazy_module_action">
                    ...
                    <div class="settings_btn <?php echo ($this->settings->getModuleStatus("pdf_invoice") == 1 ? "active" : ""); ?>" onclick="wceazy_start_module_settings(`<?php echo esc_url(WCEAZY_URL); ?>`, this)">
                        <?php esc_html_e(' Settings', 'wceazy'); ?>
                    </div>
                    <a class="wceazy_module_docs" target="_blank" href="<?php echo WCEAZY_DOCS_PAGE; ?>"><?php esc_html_e('Documentation', 'wceazy'); ?></a>
                </div>
        ...
        <div class="wceazy_module_item" data-slug="shipping_bar">
            ...
            <div class="wceazy_module_details">
                ...
                <div class="wceazy_module_action">
                    ...
                    <div class="settings_btn <?php echo ($this->settings->getModuleStatus("shipping_bar") == 1 ? "active" : ""); ?>" onclick="wceazy_start_module_settings(`<?php echo esc_url(WCEAZY_URL); ?>`, this)">
                        <?php esc_html_e('Settings', 'wceazy'); ?>
                    </div>
                    <a class="wceazy_module_docs" target="_blank" href="<?php echo WCEAZY_DOCS_PAGE; ?>"><?php esc_html_e('Documentation', 'wceazy'); ?></a>
                </div>
        ...
        <div class="wceazy_module_item" data-slug="address_book">
            ...
            <div class="wceazy_module_details">
                ...
                <div class="wceazy_module_action">
                    ...
                    <div class="settings_btn <?php echo ($this->settings->getModuleStatus("address_book") == 1 ? "active" : ""); ?>" onclick="wceazy_start_module_settings(`<?php echo esc_url(WCEAZY_URL); ?>`, this)">
                        <?php esc_html_e('Settings', 'wceazy'); ?>
                    </div>
                    <a class="wceazy_module_docs" target="_blank" href="<?php echo WCEAZY_DOCS_PAGE; ?>"><?php esc_html_e('Documentation', 'wceazy'); ?></a>
                </div>
        ...
        <div class="wceazy_module_item" data-slug="product_filter">
            ...
            <div class="wceazy_module_details">
                ...
                <div class="wceazy_module_action">
                    ...
                    <div class="settings_btn <?php echo ($this->settings->getModuleStatus("product_filter") == 1 ? "active" : ""); ?>" onclick="wceazy_start_module_settings(`<?php echo esc_url(WCEAZY_URL); ?>`, this)">
                        <?php esc_html_e('Settings', 'wceazy'); ?>
                    </div>
                    <a class="wceazy_module_docs" target="_blank" href="<?php echo WCEAZY_DOCS_PAGE; ?>"><?php esc_html_e('Documentation', 'wceazy'); ?></a>
                </div>
        ...
        <div class="wceazy_module_item" data-slug="order_cancel">
            ...
            <div class="wceazy_module_details">
                ...
                <div class="wceazy_module_action">
                    ...
                    <div class="settings_btn <?php echo ($this->settings->getModuleStatus("order_cancel") == 1 ? "active" : ""); ?>" onclick="wceazy_start_module_settings(`<?php echo esc_url(WCEAZY_URL); ?>`, this)">
                        <?php esc_html_e('Settings', 'wceazy'); ?>
                    </div>
                    <a class="wceazy_module_docs" target="_blank" href="<?php echo WCEAZY_DOCS_PAGE; ?>"><?php esc_html_e('Documentation', 'wceazy'); ?></a>
                </div>
